 ...
 * changes.
 */
export { MutationData, MousemoveData, MouseInteractionData, ScrollData, ViewportResizeData, InputData, MediaInteractionData, StyleSheetRuleData, MediaInteractions, MouseInteractions, AddedNodeMutation, MousePosition, RemovedNodeMutation, } from '../domain/record';
