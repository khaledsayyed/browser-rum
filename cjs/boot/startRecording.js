...
function startRecording(lifeCycle, configuration, sessionManager, parentContexts, worker) {
    var _a = (0, segmentCollection_1.startSegmentCollection)(lifeCycle, configuration.applicationId, sessionManager, parentContexts, function (data, meta, rawSegmentSize, flushReason) {
        return (0, send_1.send)(configuration.sessionReplayEndpointBuilder, data, meta, rawSegmentSize, flushReason);
    }, worker), addRecord = _a.addRecord, stopSegmentCollection = _a.stop;
    function addRawRecord(rawRecord) {
        addRecord((0, tslib_1.__assign)((0, tslib_1.__assign)({}, rawRecord), { timestamp: Date.now() }));
    }
